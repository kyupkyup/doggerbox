	...
	<div class="container"> 
		...
		<div class="main-container1">
			<form action="additional_informationAction.jsp?userID=<%=userID%>" method="post">
				<input type="text" name="userName" placeholder="이름" class="userName">
				<div class="address-holder">
						<input  type="button" onClick="goPopup();" value="주소찾기" class="address-button">
							...
							<input type="text" id="userAddress" value=""  name="userAddress" placeholder="주소" class="address-full-holder"/>
							
						</div>
				</div>
				<input type="text" name="userPhoneNum" placeholder="핸드폰 번호" class="userPhoneNum"/>
				<input type="text" name="userEmail" placeholder="이메일"class="userEmail"/>
