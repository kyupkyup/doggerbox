...
<jsp:setProperty name ="order" property="puppyAvailable" />
<jsp:setProperty name ="order" property="originalAvailable" />
<jsp:setProperty name ="order" property="seniorAvailable" />
<jsp:setProperty name ="order" property="fishAvailable" />
<jsp:setProperty name ="order" property="porkAvailable" />
<jsp:setProperty name ="order" property="kangarooAvailable" />
<jsp:setProperty name ="order" property="horseAvailable" />
