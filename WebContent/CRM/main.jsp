	...
	function addUserFunction(){
		...
		$.ajax({
			...
			data:{
				...
				paymentRoute:encodeURIComponent(paymentRoute)
			},
...
/* 		                    '<a href="#" class="table-link">'+
	...
	function calculateQuantity(){
		...
		if(puppyAge == null || puppyAgeMonth == null || puppyGender == null || puppyNeutralization == null || puppyWeight == null||
			...
			$('#recommendedQuantity').val(Math.floor(recommendedQuantity) + "kcal");
		}
				...
				<div class="" style="display:inline-block;  height:900px; 	">
					...
					<div class="form-group" style="height:660px;">
						...
						<div class="">
							...
							<div style="display:inline-block; width:100px;">
								<input class="form-control" type="text" placeholder="결제경로" style="display:inline-block;" id="paymentRoute">
							</div>
				...
				<div style="display:inline-block; width:360px; margin-left:30px; height:900px;">
					...
					<div class="form-group" style=" margin-bottom:0px;  height:620px;">
						...
						<div class="">
							...
							<div class="">
								<div class="" style="display:inline-block;">
									<input class="form-control" type="text" id="recommendedQuantity" style="height:30px; width:100px; display:inline-block;" placeholder="권장 급여량">
								</div>
								<div class="" style="display:inline-block;">
					...
					<div class="form-group" style=" height:380px;" id="orderRegister">
						...
						<div class="">
							<div id="orderProductPuppyRecipe">
								...
								<input type="radio" name="orderProductPuppyAvailable" value=1 />처방<input type="radio" name="orderProductPuppyAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
						...
						<div class="" >
							...
							<div id="orderProductOriginalRecipe">
								...
								<input type="radio" name="orderProductOriginalAvailable" value=1 />처방<input type="radio" name="orderProductOriginalAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
						...
						<div class="">
							...
							<div id="orderProductSeniorRecipe">
								...
								<input type="radio" name="orderProductSeniorAvailable" value=1 />처방<input type="radio" name="orderProductSeniorAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
						...
						<div class="">
							...
							<div id="orderProductFishRecipe">
								...
								<input type="radio" name="orderProductFishAvailable" value=1 />처방<input type="radio" name="orderProductFishAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
						...
						<div class="">
							...
							<div id="orderProductPorkRecipe">
								...
								<input type="radio" name="orderProductPorkAvailable" value=1 />처방<input type="radio" name="orderProductPorkAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
						...
						<div class="">
							...
							<div id="orderProductKangarooRecipe">
								...
								<input type="radio" name="orderProductKangarooAvailable" value=1 />처방<input type="radio" name="orderProductKangarooAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
						...
						<div class="">
							...
							<div id="orderProductHorseRecipe">
								...
								<input type="radio" name="orderProductHorseAvailable" value=1 />처방<input type="radio" name="orderProductHorseAvailable" value=0 Checked />비처방<input type="radio" name="orderProductKangarooAvailable" value=2 Checked />저단백
