...
<button onclick="location.href='../main.jsp'">메인</button>
	<p><%=ingredientDAO.getRawIngredient(ingredientPrimeNum)%> 배합비 입력</p>
		...
		<form action="puppyCustomRecipeMixRateUpdateAction.jsp?puppyPrimeNum=<%=puppyPrimeNum%>&ingredientPrimeNum=<%=ingredientPrimeNum%>&recipePrimeNum=<%=recipePrimeNum%>" method="post">
